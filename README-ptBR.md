...
Aproxime-se da entrada da loja para ativá-la. A loja pausará o jogo e permitirá que você compre upgrades usando sua **GRANA** (score) acumulada.
...
- [Arquitetura Geral (`ARCHITECTURE-ptBR.md`)](docs/ARCHITECTURE-ptBR.md): Detalha o Main Loop, separação de Estados, Gerenciadores e como as mecânicas convergem.
- [A Lógica das Entidades (`ENTITIES-ptBR.md`)](docs/ENTITIES-ptBR.md): Abrange as instâncias de inimigos, tiros, jogadores e como os estados atuam em seus ciclos de vida (Desenho, Interação, Lixeira).
- [O Sistema Ambiental (`ENVIRONMENT-ptBR.md`)](docs/ENVIRONMENT-ptBR.md): Como funciona a rolagem contínua das fases, Parallax, spawnings independentes (Estátuas e Lojas) e Checagem Pixeladas de colisões de terrenos.
